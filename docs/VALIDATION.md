...
- Logo invariants cover equal arcs/gaps, the right-facing opening, mandatory centred dot and matching downloadable SVG. Twenty-eight semantic reading/action colour pairs meet a 4.5:1 threshold.
