        ...
        <main className="main-content">
          <section className="overview" id="overview">
            <span className="eyebrow">
              ...
              {t("The Standkreis design system", "Das Standkreis Designsystem")}
            </span>
            <h1>
              {t("One place.", "Ein gemeinsamer Ort.")}
              <br />
              <span>
                {t("Many ways to discover.", "Viele Wege zu entdecken.")}
              </span>
            </h1>
            <p className="lede">
              {t(
                "A shared visual language for exploring nature and shaping thriving ecosystems together. Calm, curious and ready to participate.",
                "Eine gemeinsame visuelle Sprache, um Natur zu erkunden und lebendige Ökosysteme zu gestalten. Ruhig, neugierig und offen fürs Mitmachen.",
              )}
            </p>
            <div className="intro-actions">
              <Button asChild>
                <a href="#components">
                  {t("Explore components", "Komponenten erkunden")}
                  <ArrowRight aria-hidden="true" />
                </a>
              </Button>
              <Button asChild variant="outline">
                <a href="#use">{t("Start building", "Loslegen")}</a>
              </Button>
              <span className="version-note">
                {t(
                  "First foundation · evolving together",
                  "Erste Grundlage · gemeinsam weiterentwickeln",
                )}
              </span>
            </div>
          ...
          >
            <div className="swatch-grid">
              {[
                ...
                ["secondary", t("Soft accent", "Sanfter Akzent")],
                ...
                <CardContent className="specimen-content">
                  <div className="button-row">
                    ...
                    <Button variant="secondary" asChild>
                      <a href="#guidance">{t("Learn more", "Mehr erfahren")}</a>
                    </Button>
                    <Button disabled>
          ...
          >
            <div className="pattern-grid">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {t("A gentle change of focus", "Ein sanfter Fokuswechsel")}
                  </CardTitle>
                  <CardDescription>
                    {t(
